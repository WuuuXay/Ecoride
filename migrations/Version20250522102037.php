 ...
 */
final class Version20250522102037 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, pseudo VARCHAR(50) NOT NULL, credits INT NOT NULL, telephone VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, is_chauffeur TINYINT(1) NOT NULL, is_passager TINYINT(1) NOT NULL, accepte_fumeurs TINYINT(1) DEFAULT NULL, accepte_animaux TINYINT(1) DEFAULT NULL, preferences_supplementaires VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) NOT NULL, photo_profil VARCHAR(255) DEFAULT NULL, note_moyenne DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
